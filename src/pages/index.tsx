  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Management Application: Your ultimate destination for seamless and efficient Human Resources operations, empowering businesses for success."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Management Application: Your ultimate destination for seamless and efficient Human Resources operations, empowering businesses for success.`}
            </Text>
            <Box
